...
layout: post
category : lessons
tagline: "I should write some thing for Supporting tagline"
tags : [intro, beginner, jekyll, tutorial]
---
# suppose I forget the line {% include JB/setup %}

This Jeky ll introduction will outline specifically  what Jekyll is and why you would want to use it.
